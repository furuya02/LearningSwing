...
public class InetTest {
	...
	public static final class A004 {
		...
		@DataPoints
		public static Fixture[] datas = {
				new Fixture(new byte[]{ 0x62, 0x0d, 0x0a, 0x62, 0x0d, 0x0a, 0x62}, 3),
				new Fixture(new byte[]{ 0x62, 0x0d, 0x0a, 0x62, 0x0d, 0x0a, 0x62, 0x0d, 0x0a}, 3),
				new Fixture(new byte[]{ 0x62, 0x0d, 0x0a}, 1),
				new Fixture(new byte[]{ 0x0d, 0x0a}, 1),
				new Fixture(new byte[]{ }, 0),
				new Fixture(null, 0),
		};
		static class Fixture {
			private byte [] buf;
	...
	public static final class A006 {
		...
		@DataPoints
		public static Fixture[] datas = {
			new Fixture(new byte[] { 0x64 }, new byte[] { 0x64 }),
			new Fixture(new byte[] { 0x64, 0x0d, 0x0a }, new byte[] { 0x64 }),
			new Fixture(new byte[] { 0x64, 0x0d }, new byte[] { 0x64, 0x0d}),
	...
	public static final class A007 {
		...
		@DataPoints
		public static Fixture[] datas = {
			new Fixture("<HTML>", "&lt;HTML&gt;"),
			new Fixture("R&B", "R&amp;B"),
			new Fixture("123~", "123%7E"),
		};
		static class Fixture {
			private String str;
			private String expected;
	...
	public static final class A008 {
		...
		@DataPoints
		public static Fixture[] datas = {
			new Fixture("<HTML>", "BE-90-72-8C-11-BF-70-8F-52-50-28-A6-78-0F-8E-17"),
			new Fixture("abc", "90-01-50-98-3C-D2-4F-B0-D6-96-3F-7D-28-E1-7F-72"),
			new Fixture("", "D4-1D-8C-D9-8F-00-B2-04-E9-80-09-98-EC-F8-42-7E"),
			new Fixture(null, ""),		
		};
		static class Fixture {
			private String str;
